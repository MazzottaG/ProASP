...
public:
 Stratum_edge_b821c9a100eb5b8d(SymbolTable& symTable,RecordTable& recordTable,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_ii__0_1__11__10::Type& rel_edge_f2967ee81645a356);
...
t_btree_ii__0_1__11__10::Type* rel_edge_f2967ee81645a356;
};
} // namespace souffle
namespace souffle {
 Stratum_edge_b821c9a100eb5b8d::Stratum_edge_b821c9a100eb5b8d(SymbolTable& symTable,RecordTable& recordTable,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_ii__0_1__11__10::Type& rel_edge_f2967ee81645a356):
symTable(symTable),
recordTable(recordTable),
...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"fact-dir","test-souffle"},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
public:
 Stratum_path_04e315f6f499c9d3(SymbolTable& symTable,RecordTable& recordTable,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_ii__0_1__11::Type& rel_delta_path_325b33c724e55970,t_btree_ii__0_1__11::Type& rel_new_path_f62f3c3704df2e4a,t_btree_ii__0_1__11__10::Type& rel_edge_f2967ee81645a356,t_btree_ii__0_1__11::Type& rel_path_2405b3b40fb3c138);
void run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret);
private:
SymbolTable& symTable;
RecordTable& recordTable;
...
std::string& inputDirectory;
std::string& outputDirectory;
t_btree_ii__0_1__11::Type* rel_delta_path_325b33c724e55970;
t_btree_ii__0_1__11::Type* rel_new_path_f62f3c3704df2e4a;
t_btree_ii__0_1__11__10::Type* rel_edge_f2967ee81645a356;
t_btree_ii__0_1__11::Type* rel_path_2405b3b40fb3c138;
};
} // namespace souffle
namespace souffle {
 Stratum_path_04e315f6f499c9d3::Stratum_path_04e315f6f499c9d3(SymbolTable& symTable,RecordTable& recordTable,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_ii__0_1__11::Type& rel_delta_path_325b33c724e55970,t_btree_ii__0_1__11::Type& rel_new_path_f62f3c3704df2e4a,t_btree_ii__0_1__11__10::Type& rel_edge_f2967ee81645a356,t_btree_ii__0_1__11::Type& rel_path_2405b3b40fb3c138):
symTable(symTable),
recordTable(recordTable),
pruneImdtRels(pruneImdtRels),
performIO(performIO),
...
rel_new_path_f62f3c3704df2e4a->purge();
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"name","path"},{"operation","output"},{"output-dir","test-souffle"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
namespace souffle {
class Sf_exec: public SouffleProgram {
public:
 Sf_exec();
 ~Sf_exec();
void run();
...
Own<t_btree_ii__0_1__11__10::Type> rel_edge_f2967ee81645a356;
souffle::RelationWrapper<t_btree_ii__0_1__11__10::Type> wrapper_rel_edge_f2967ee81645a356;
Own<t_btree_ii__0_1__11::Type> rel_path_2405b3b40fb3c138;
souffle::RelationWrapper<t_btree_ii__0_1__11::Type> wrapper_rel_path_2405b3b40fb3c138;
Own<t_btree_ii__0_1__11::Type> rel_delta_path_325b33c724e55970;
Own<t_btree_ii__0_1__11::Type> rel_new_path_f62f3c3704df2e4a;
...
symTable(),
recordTable(),
rel_edge_f2967ee81645a356(mk<t_btree_ii__0_1__11__10::Type>()),
...
rel_path_2405b3b40fb3c138(mk<t_btree_ii__0_1__11::Type>()),
...
rel_delta_path_325b33c724e55970(mk<t_btree_ii__0_1__11::Type>()),
rel_new_path_f62f3c3704df2e4a(mk<t_btree_ii__0_1__11::Type>()),
stratum_edge_bd08e9a8f799e828(symTable,recordTable,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_edge_f2967ee81645a356),
stratum_path_32ce85b2a32d6a1b(symTable,recordTable,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_delta_path_325b33c724e55970,*rel_new_path_f62f3c3704df2e4a,*rel_edge_f2967ee81645a356,*rel_path_2405b3b40fb3c138){
...
void Sf_exec::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf_exec::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf_exec::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"name","path"},{"operation","output"},{"output-dir","test-souffle"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf_exec::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"fact-dir","test-souffle"},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
SymbolTable& Sf_exec::getSymbolTable(){
return symTable;
}

RecordTable& Sf_exec::getRecordTable(){
return recordTable;
}

void Sf_exec::setNumThreads(std::size_t numThreadsValue){
SouffleProgram::setNumThreads(numThreadsValue);
symTable.setNumLanes(getNumThreads());
recordTable.setNumLanes(getNumThreads());
}

void Sf_exec::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
if (name == "edge") {
stratum_edge_bd08e9a8f799e828.run(args, ret);
return;}
if (name == "path") {
...
namespace souffle {
SouffleProgram *newInstance_exec(){return new Sf_exec;}
SymbolTable *getST_exec(SouffleProgram *p){return &reinterpret_cast<Sf_exec*>(p)->getSymbolTable();}
} // namespace souffle
...
{
try{
souffle::CmdOptions opt(R"(test-souffle/reach.dl)",
R"()",
R"()",
false,
R"()",
...
namespace souffle {
class factory_Sf_exec: souffle::ProgramFactory {
public:
...
namespace souffle {
SouffleProgram* factory_Sf_exec::newInstance(){
return new Sf_exec();
}

 factory_Sf_exec::factory_Sf_exec():
ProgramFactory("exec"){
}
...
extern "C" {
factory_Sf_exec __factory_Sf_exec_instance;
}
#endif
} // namespace souffle
